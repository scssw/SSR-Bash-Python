...
echo -e "\e[38;5;198m霉\e[38;5;202m运\e[38;5;208m退\e[38;5;214m散\e[0m，\e[38;5;220m原\e[38;5;226m地\e[38;5;190m起\e[38;5;82m飞\e[0m"

# 预定义彩虹色数组
# 调整后的渐变色数组（红→黄→绿→蓝）
colors=("202" "208" "214" "220" "226" "190" "118" "46" "33" "21")
index=0
...
for item in "${menu_items[@]}"; do
    color=${colors[index]}
    printf "\e[38;5;245m│\e[0m \e[38;5;${color}m%-18s\e[0m \e[38;5;245m│\e[0m\n" "$item"
    ((index = (index + 1) % ${#colors[@]}))
done
echo -e "\e[38;5;245m└──────────────────┘\e[0m"
echo -e "\e[1;36m====================\e[0m"
echo -e "\e[38;5;245m提示: 按回车键退出\e[0m"
while :; do echo
	read -p "请选择： " choice
	if [[ -z $choice ]]; then
		echo "已退出系统"
		exit 0
	elif [[ ! $choice =~ ^[0-6]$ ]]; then
		echo "输入错误! 请输入正确的数字!"
	else
		echo 
		echo 
